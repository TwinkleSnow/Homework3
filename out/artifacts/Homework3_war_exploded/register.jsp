...
<div class="container">
    ...
    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath }/RegisServlet"
          method="post">
        ...
        <div class="form-group">
            <div class="col-sm-push-2 col-sm-8 input-group">
                ...
                <input type="text" class="form-control input-block input-lg" id="inputUsername4" name="userid"
                       placeholder="id"/>
            </div>
        </div>
        <div class="col-sm-12" style="height: 50px;"></div>
